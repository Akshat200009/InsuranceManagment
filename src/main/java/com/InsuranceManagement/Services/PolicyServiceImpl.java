...
public class PolicyServiceImpl implements PolicyService {
	...
	public List<PolicyResponse> getAllPolicies() {
		...
		return policyRepository.findAll().stream().map(this::convertToResponse).toList();
	}
	...
	public List<PolicyResponse> getExpiringPolicies() {
		...
		List<Policy> policies = policyRepository.findByEndDateBetweenAndStatus(today, nextSevenDays,
				PolicyStatus.ACTIVE);
