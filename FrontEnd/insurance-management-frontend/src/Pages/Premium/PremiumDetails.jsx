...
function PremiumDetails() {
    ...
    const loadPremium = async () => {
        ...
        try {
            ...
            /*
             * CUSTOMER
             * Only access his own premium
             */
            if (role === "CUSTOMER") {

                response =
                    await premiumService.getMyPremiumById(id);
             ...
             */
                ...
                response =
                    await premiumService.getPremiumById(id);
             ...
             * Payment history
             *
             * Currently using existing history endpoint.
             * Customer-specific history can be secured
             * separately on backend.
             */
            loadHistory(response.policyId);

            /*
             * These are global reports.
             * Only ADMIN / AGENT should load them.
             */
            if (role !== "CUSTOMER") {
            ...
            toast.error(
                ...
                "Unable to load premium details"
            );
    ...
    const loadHistory = async (policyId) => {
        ...
        try {
            ...
            const response =
                await premiumService.getPaymentHistory(policyId);
    ...
    const loadDuePremiums = async () => {
        ...
        try {
            ...
            const response =
                await premiumService.getDuePremiums();
    ...
    const loadOverduePremiums = async () => {
        ...
        try {
            ...
            const response =
                await premiumService.getOverduePremiums();
    ...
    return (
        ...
        <DashboardLayout>
            ...
            <div className="p-8">
                ...
                {/* Overdue Premiums - ADMIN / AGENT ONLY */}
