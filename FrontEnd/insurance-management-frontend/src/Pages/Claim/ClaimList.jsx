  ...
  const loadClaims = async () => {
    try {
      ...
      // ================= ADMIN / AGENT =================
        ...
        switch (filter) {
          case "APPROVED":
            response = await claimService.getClaimsByStatus("APPROVED");

            break;

          case "REJECTED":
            response = await claimService.getClaimsByStatus("REJECTED");

            break;

          default:
            response = await claimService.getPendingClaims();
        }
      }
  ...
  const handleApprove = async (claim) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.response?.data?.message || "Unable to approve claim.",
      });
    }
  };
  ...
  const handleReject = async (claim) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.response?.data?.message || "Unable to reject claim.",
      });
    }
  };
